        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
              <div>
                <label style={{ fontSize: 11, color: 'var(--text-muted)', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 4, marginBottom: 4 }}>
        ...
        <div className="card">
          ...
          <div style={{ padding: 24, background: 'var(--bg-hover)', borderRadius: 16 }}>
             ...
             {school.plan_status === 'Active' ? (
               <div style={{ color: 'var(--green)', display: 'flex', alignItems: 'center', gap: 8, fontSize: 14 }}>
                 <CheckCircle2 size={16} /> Your account is fully verified and secure.
               </div>
             ) : (
               <div style={{ color: '#f59e0b', display: 'flex', alignItems: 'center', gap: 8, fontSize: 14 }}>
